...
class LambdaHandlerTestCase(unittest.TestCase):
    ...
    def testUploadFileInvoked(self):
        with patch('services.s3_service.upload_file') as upload_file_mock:
    ...
    def testDeleteFileInvoked(self):
        with patch('services.s3_service.delete_file') as delete_file_mock:
    ...
    def testStoreFileMetadataInvoked(self):
        with patch('services.dynamo_service.store_file_metadata') as store_file_metadata_mock:
    ...
    def testReadFileMetadataInvoked(self):
        with patch('services.dynamo_service.read_file_metadata') as read_file_metadata_mock:
    ...
    def testDeleteFileMetadataInvoked(self):
        with patch('services.dynamo_service.delete_file_metadata') as delete_file_metadata_mock:
